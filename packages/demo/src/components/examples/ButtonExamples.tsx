        ...
        return (
            <Section>
                ...
                >
                    ...
                    >
                        <Button enabled name="Default" />
                        <Button enabled primary name="Primary Button" />
                        <Button enabled classes={['mod-danger']} name="Danger Button" />
                        <Button enabled classes={['mod-link']} name="Borderless Button" />
                    </Section>
                    <Section level={3} title="Color modifiers disabled" description="Disabled state for each colors">
                        ...
                        <Button enabled={false} primary name="Primary Button">
                            <Svg svgName={'add'} className="icon mod-normal ml1" />
                        </Button>
                    ...
                    <Section level={3} title="Color modifiers svg" description="Svg style for each colors">
                        ...
                        <Button enabled primary name="Default">
                            <Svg svgName={'add'} className="icon mod-normal ml1" />
                        </Button>
                        <Button enabled classes={['mod-danger']} name="Default">
                            <Svg svgName={'add'} className="icon mod-normal ml1" />
                        </Button>
                        <Button enabled classes={['mod-link']} name="Default">
                            <Svg svgName={'add'} className="icon mod-normal ml1" />
                        </Button>
                    </Section>
                    <Section title="Size modifiers" level={3} description="Change the size of the buttons.">
                        <Button enabled classes={['mod-small']} name="Small" />
                        <Button enabled name="Default" />
                        <Button enabled classes={['mod-large']} name="Large" />
                    </Section>
                </Section>
                <Section
                ...
                >
                    <Button enabled classes={['mod-prepend']}>
                        <span className="btn-prepend">P</span>
                        Prepend Button
                    </Button>
                    <Button enabled classes={['mod-append']} name="Button Append">
                        <span className="btn-append">A</span>
                    </Button>
                    <Button enabled classes={['mod-prepend', 'mod-large']}>
                    ...
                    <Button enabled classes={['mod-append', 'mod-on-hover']} name="Append on Hover">
                        <span className="btn-append">A</span>
                    </Button>
                </Section>
                <Section title="Actions" level={2} description="Add actions associated with buttons">
                    <Section level={3} title="Link" description="Add a hyperlink to a button">
                        <Button enabled name="Link Button" link="http://perdu.com/" target="_blank" />
                    </Section>
                    <Section level={3} title="Callback" description="Add a on click callback to a button">
                        <Button enabled name="Button click me!" onClick={() => alert('Hello')} />
                    </Section>
                </Section>
                <Section level={2} title="Tooltips" description="Add a tooltip with a button">
                    <Button enabled name="Button with tooltip" tooltip="Tooltip test" />
                    <Button enabled name="Button with tooltip top" tooltip="Tooltip test" tooltipPlacement="top" />
                </Section>
